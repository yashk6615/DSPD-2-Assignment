...
//function to add individual in individual list
...
// function that checks is individual already added in other group
...
//function that deletes individual
...
//function that checks group has achieved their weekly goals or not
...
//function that gives top 3 individual from individual list
...
//function that checks individual has done its daily step goal
...
//function that suggest an individual so that it can come in top3
...
//function that generates leaderboard of groups
...
//function that display group information
...
//function that merges two groups
...
//function that display all individual info
